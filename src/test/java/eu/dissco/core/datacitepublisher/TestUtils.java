...
public class TestUtils {
	...
	public static final List<String> LOCS_ARR = List.of("https://sandbox.dissco.tech/ds/10.3535/QR1-P21-9FW",
	...
	public static DcAttributes givenSpecimenDataCiteAttributes(String doi) {
		return DcAttributes.builder()
			.suffix(SUFFIX)
			.doi(doi)
			.creators(List.of(DcCreator.builder().name(HOST_NAME).nameIdentifiers(List.of(givenIdentifier())).build()))
			.titles(List.of(DcTitle.builder().title(REFERENT_NAME).build()))
			.publicationYear(2024)
			.contributors(List
				.of(DcContributor.builder().name(HOST_NAME).nameIdentifiers(List.of(givenIdentifier())).build()))
	...
	private static DcDate givenDcIssueDate() {
		return DcDate.builder().dateType("Issued").date("2024-03-08").build();
	}
	...
	private static DcRelatedIdentifiers givenDcRelatedIdentifiers() {
		return DcRelatedIdentifiers.builder()
			...
			.relatedIdentifier("https://sandbox.dissco.tech/api/v1/specimens/10.3535/QR1-P21-9FW")
	...
	public static DcType givenType(String resourceType) {
		...
		return DcType.builder().resourceType(resourceType).resourceTypeGeneral(resourceTypeGeneral).build();
	}
	...
	public static DcAttributes givenSpecimenDataCiteAttributesFull() {
		return DcAttributes.builder()
			...
			.alternateIdentifiers(List.of(DcAlternateIdentifier.builder()
				...
				.alternateIdentifier(LOCAL_ID)
				.build()))
			.dates(List.of(DcDate.builder().date("2024-03-08").dateType("Issued").build()))
			.relatedIdentifiers(List.of(DcRelatedIdentifiers.builder()
				.relationType(RelationType.IS_VARIANT_FORM_OF)
				.relatedIdentifier("https://sandbox.dissco.tech/api/v1/specimens/10.3535/QR1-P21-9FW")
				.relatedIdentifierType("URL")
				.build()))
			...
			.rightsList(getRights())
			.subjects(List.of(
					DcSubject.builder().subjectScheme("topicDiscipline").subject(TOPIC_DISCIPLINE.value()).build(),
					DcSubject.builder().subjectScheme("topicDomain").subject(TOPIC_DOMAIN.value()).build(),
					DcSubject.builder().subject(TOPIC_CATEGORY.value()).subjectScheme("topicCategory").build()))
			.publisher(DEFAULT_PUBLISHER)
	...
	public static JsonNode givenDcRequest(DcAttributes attributes) {
		return MAPPER.valueToTree(DcRequest.builder().data(DcData.builder().attributes(attributes).build()).build());
	}
	...
	public static DcAttributes givenMediaAttributes() {
		return DcAttributes.builder()
			...
			.contributors(List
				.of(DcContributor.builder().name(HOST_NAME).nameIdentifiers(List.of(givenIdentifier())).build()))
			.subjects(List.of(DcSubject.builder()
	...
	public static DcAttributes givenMediaAttributesFull() {
		return DcAttributes.builder()
			...
			.alternateIdentifiers(List.of(DcAlternateIdentifier.builder()
				...
				.build()))
			.rightsList(getRights())
			.dates(List.of(DcDate.builder().dateType("Issued").date("2024-03-08").build()))
			.relatedIdentifiers(List.of(DcRelatedIdentifiers.builder()
				.relationType(RelationType.IS_VARIANT_FORM_OF)
				.relatedIdentifier("https://sandbox.dissco.tech/api/v1/specimens/10.3535/QR1-P21-9FW")
				.relatedIdentifierType("URL")
			...
			.url("https://sandbox.dissco.tech/ds/10.3535/QR1-P21-9FW")
			.publisher(DEFAULT_PUBLISHER)
			.subjects(List.of(DcSubject.builder().subjectScheme("mediaFormat").subject("jpg").build(),
					DcSubject.builder()
						.subjectScheme("linkedDigitalObjectType")
						.subject(DIGITAL_SPECIMEN_TYPE)
						.build()))
	...
	private static List<DcDescription> givenSpecimenDescription() {
		return List.of(DcDescription.builder()
	...
	private static List<DcDescription> givenSpecimenDescriptionFull() {
		...
		descriptions
			.add(DcDescription.builder().description("Material sample type is " + MATERIAL_SAMPLE_TYPE + ".").build());
		return descriptions;
	}

	private static List<DcDescription> givenMediaDescriptionFull() {
		return List.of(DcDescription.builder().description("Media object hosted at " + HOST_NAME + ".").build(),
				DcDescription.builder()
					.description("Is media for an object of type " + DIGITAL_SPECIMEN_TYPE + ".")
					.build());
	}
	...
	public static DigitalSpecimen givenDigitalSpecimen(String doi) {
		return new DigitalSpecimen().with10320Loc(LOCS)
			.withPid(doi)
	...
	public static DigitalSpecimen givenDigitalSpecimenFull() {
		return givenDigitalSpecimen().withTopicDiscipline(TOPIC_DISCIPLINE)
	...
	public static DigitalMedia givenDigitalMedia(String pid) {
		return new DigitalMedia().with10320Loc(LOCS)
			.withPid(pid)
			.withIssuedForAgent(ROR)
			.withIssuedForAgentName(HOST_NAME)
			.withPidRecordIssueDate(PID_ISSUE_DATE)
	...
	public static DigitalMedia givenDigitalMediaFull() {
		return givenDigitalMedia().withMimeType("jpg");
	}

	public static TombstoneEvent givenTombstoneEvent() {
		return new TombstoneEvent(DOI, List.of(givenDcRelatedIdentifiersTombstone()));
	}
		...
		return DcRequest.builder()
			.data(DcData.builder()
				.attributes(DcAttributes.builder()
					.doi(DOI)
					.rightsList(getRights())
					.relatedIdentifiers(List.of(givenDcRelatedIdentifiers(), givenDcRelatedIdentifiersTombstone()))
					.dates(List.of(givenDcIssueDate(),
							DcDate.builder().date("2024-04-09").dateType("Withdrawn").build()))
	...
	public static JsonNode givenDigitalSpecimenPidRecord() {
		...
		return MAPPER.createObjectNode()
			...
			.set("data", MAPPER.createArrayNode().add(specimen1).add(specimen2));
	}
	...
	public static JsonNode givenDigitalSpecimenPidRecordSingle(String pid) {
		...
		return MAPPER.createObjectNode()
			.put("links", "https://dev.dissco.tech/api/v1/pids/records")
			.set("data", MAPPER.createArrayNode().add(specimen1));
	}
	...
	public static JsonNode givenDigitalMediaJson() {
		...
		return MAPPER.createObjectNode()
			.put("links", "https://dev.dissco.tech/api/v1/pids/records")
			.set("data", MAPPER.createArrayNode().add(media1).add(media2));
	}
